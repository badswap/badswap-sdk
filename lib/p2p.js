...
exports.BadP2P = exports.cryptoFromSeed = exports.fromJSONtoBuffer = exports.fromBufferToJSON = exports.stringToBuffer = exports.bufferToString = void 0;
...
class BadP2P extends libp2p_1.default {
    ...
    static toMessage(password) {
        return ("/badp2p/1.0.0/" +
            (0, ethers_2.solidityPackedKeccak256)(["string"], ["/badp2p/1.0.0/" + password]));
    }
    ...
    constructor(options) {
        const multiaddr = BadP2P.fromPresetOrMultiAddr(options.multiaddr || "mainnet");
        super({
